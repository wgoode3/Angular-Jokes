...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.togglePunchline = function () {
        this.showPunchline = !this.showPunchline;
    };
    AppComponent.prototype.getNewJoke = function () {
        var _this = this;
        var comedian = this._httpService.getJoke();
        comedian.subscribe(function (data) {
            _this.showPunchline = false;
            _this.setup = data["setup"];
            _this.punchline = data["punchline"];
        });
    };
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getJoke = function () {
...
module.exports = __webpack_require__(/*! /home/hygogg/Desktop/jokes/src/main.ts */"./src/main.ts");
